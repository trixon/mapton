...
public class WorldClockTool extends MToolMapAddOn {
    ...
    public static final String NAME = NbBundle.getMessage(WorldClockTool.class, "worldClock");
//    private ResourceBundle mBundle = NbBundle.getBundle(WorldClockTool.class);
