...
public class SeasonalSOSB extends MSimpleObjectStorageBoolean.Misc {

    private final ResourceBundle mBundle = NbBundle.getBundle(SeasonalSOSB.class);

    public SeasonalSOSB() {
        setGroup(Dict.ADD_ONS.toString());
