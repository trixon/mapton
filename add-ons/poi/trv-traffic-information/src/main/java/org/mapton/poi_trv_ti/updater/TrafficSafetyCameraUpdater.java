...
public class TrafficSafetyCameraUpdater extends BaseUpdater {

    public TrafficSafetyCameraUpdater() {
        setFile(mManager.getFile(Service.TRAFFIC_SAFETY_CAMERA));
        setComment("Speed cams");
