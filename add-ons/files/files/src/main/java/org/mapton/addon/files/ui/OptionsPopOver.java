...
import org.mapton.addon.files.api.Mapo;
import org.mapton.addon.files.api.FilesSettings;
import org.mapton.addon.files.api.FilesSettings.SplitBy;
...
public class OptionsPopOver extends PopOver {
    ...
    private void load() {
        FilesSettings settings = mMapo.getSettings();
