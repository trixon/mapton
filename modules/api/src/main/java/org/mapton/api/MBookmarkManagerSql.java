...
public class MBookmarkManagerSql extends DbBaseManager {
    ...
    private final ObjectProperty<ObservableList<MBookmarkSql>> mItemsProperty = new SimpleObjectProperty<>();
    ...
    public static MBookmarkManagerSql getInstance() {
        return Holder.INSTANCE;
    }

    private MBookmarkManagerSql() {
    ...
    public synchronized void dbDelete(MBookmarkSql bookmark) throws ClassNotFoundException, SQLException {
    ...
    public synchronized void dbDelete(String category) throws ClassNotFoundException, SQLException {
        for (var bookmark : mItemsProperty.get()) {
    ...
    public synchronized void dbInsert(MBookmarkSql bookmark) throws ClassNotFoundException, SQLException {
        dbInsertSilent(bookmark);
        dbLoad();
    }

    public synchronized Point dbInsert(ArrayList<MBookmarkSql> bookmarks) {
        int imports = 0;
        int errors = 0;
    ...
    public synchronized ArrayList<MBookmarkSql> dbLoad() {
        return dbLoad(mStoredFilter, true);
    }

    public synchronized ArrayList<MBookmarkSql> dbLoad(String filter, boolean addToList) {
        ...
        ArrayList<MBookmarkSql> bookmarks = new ArrayList<>();
    ...
    public void dbUpdate(MBookmarkSql bookmark) throws SQLException {
    ...
    public final ObservableList<MBookmarkSql> getItems() {
        return mItemsProperty.get();
    }

    public void goTo(MBookmarkSql bookmark) throws ClassNotFoundException, SQLException {
        Mapton.getEngine().panTo(new MLatLon(bookmark.getLatitude(), bookmark.getLongitude()), bookmark.getZoom());
    }

    public final ObjectProperty<ObservableList<MBookmarkSql>> itemsProperty() {
    ...
    private void dbInsertSilent(MBookmarkSql bookmark) throws ClassNotFoundException, SQLException {
    ...
    private static class Holder {
        ...
        private static final MBookmarkManagerSql INSTANCE = new MBookmarkManagerSql();
    }
}
