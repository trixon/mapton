...
import org.mapton.core.actions.ClearLayersAction;
...
public class ClearLayersTool extends MToolMapCommand {
    ...
    public Action getAction() {
        Action action = new Action(ClearLayersAction.getName(), evt -> {
            SwingHelper.runLater(() -> {
                Actions.forID("Mapton", "org.mapton.core.actions.ClearLayersAction").actionPerformed(null);
            });
        });
    ...
    public KeyCodeCombination getKeyCodeCombination() {
        return new KeyCodeCombination(KeyCode.L, KeyCombination.SHORTCUT_DOWN, KeyCombination.SHIFT_DOWN);
    }
