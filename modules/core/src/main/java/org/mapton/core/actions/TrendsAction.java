...
@ActionReferences({
    ...
    @ActionReference(path = "Menu/MapTools", position = 1410)
})
@NbBundle.Messages({
    "CTL_TrendsAction=Tr&ends"
})
public final class TrendsAction extends BaseAction {

    @Override
    public void actionPerformed(ActionEvent e) {
        if (isMapActive()) {
            toggleTopComponent("TrendsTopComponent");
        }
    }
}
