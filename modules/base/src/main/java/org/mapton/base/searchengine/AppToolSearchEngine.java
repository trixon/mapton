...
public class AppToolSearchEngine implements MSearchEngine {

    public AppToolSearchEngine() {
    }

    @Override
    public String getName() {
        return Dict.APPLICATION_TOOLS.toString();
    }
    ...
    public ArrayList<MBookmark> getResults(String searchString) {
        ...
        Lookup.getDefault().lookupAll(MToolApp.class).stream()
