 ...
 */
public class MeteoAttributeManager extends BaseAttributeManager {
    ...
    public static MeteoAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private MeteoAttributeManager() {
    }
    ...
    private static class Holder {
        ...
        private static final MeteoAttributeManager INSTANCE = new MeteoAttributeManager();
    }
}
