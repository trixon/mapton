...
public class MeteoAirPreasureChartOverlay extends BaseMeteoChartOverlay {

    public static final Color COLOR = Color.BLUE.brighter();

    public MeteoAirPreasureChartOverlay() {
        super(SDict.AIR_PREASURE.toString());
    }
