 ...
 */
public class MeteoLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static MeteoLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private MeteoLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final MeteoLayerOptions INSTANCE = new MeteoLayerOptions();
    }
}
