 ...
 */
@ConvertAsProperties(
        dtd = "-//org.mapton.butterfly-meteo//Meteo//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "MeteoTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE",
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "mapTools", openAtStartup = false)
@ActionID(category = "Butterfly", id = "org.mapton.butterfly-meteo.MeteoTopComponent")
@ActionReferences({
    @ActionReference(path = "Menu/MapTools/Butterfly/Acoustic", position = 1)
})
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_MeteoAction",
        preferredID = "MeteoTopComponent"
)
@Messages({
    "CTL_MeteoAction=Meteo"
})
