 ...
 */
public class MeteoLayerOptionsView extends BLayerOptionsView {
    ...
    public MeteoLayerOptionsView(MeteoLayerBundle layerBundle) {
        super(layerBundle, SDict.METEOROLOGY.toString(), MeteoLayerOptions.getInstance(), "meteo");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), MeteoLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(MeteoLabelBy.class, mLayerOptions.labelByProperty().get().name(), MeteoLayerOptions.DEFAULT_LABEL_BY));
