 ...
 */
public class MeteoPropertiesBuilder extends BPropertiesBuilder<BMeteoPoint> {

    private final ResourceBundle mBundle = NbBundle.getBundle(MeteoPropertiesBuilder.class);

    @Override
    public Object build(BMeteoPoint p) {
        if (p == null) {
            return p;
        }
