 ...
 */
package org.mapton.butterfly_meteo.graphics;
...
import org.mapton.butterfly_meteo.MeteoAttributeManager;
import org.mapton.butterfly_meteo.MeteoManager;
 ...
 */
public abstract class GraphicRendererBase extends BaseGraphicRenderer<GraphicItem, BMeteoPoint> {
    ...
    protected final MeteoAttributeManager mAttributeManager = MeteoAttributeManager.getInstance();
    protected final MeteoManager mManager = MeteoManager.getInstance();
    ...
    public boolean isValidFor3dPlot(BMeteoPoint p) {
    ...
    protected boolean isPlotLimitReached(BMeteoPoint p, Object key, Position position) {
