...
public class MeteoMultiChartPart extends BMultiChartPart {

    public MeteoMultiChartPart() {
    }
    ...
    public BaseManager getManager() {
        return MeteoManager.getInstance();
    }
    ...
    @Override
    public ArrayList<BMeteoPoint> getPoints(MLatLon latLon, LocalDate firstDate, LocalDate date, LocalDate lastDate) {
        var pointList = MeteoManager.getInstance().getTimeFilteredItems().stream()
                .filter(p -> {
                    try {
