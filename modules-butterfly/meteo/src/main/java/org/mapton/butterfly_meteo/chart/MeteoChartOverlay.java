...
import org.mapton.butterfly_meteo.MeteoChartSOSB;
...
public class MeteoChartOverlay extends BChartOverlay {
    ...
    public synchronized void plot(XYPlot plot, BBasePoint p, LocalDate aStartDate) {
        if (!mObjectStorageManager.getBoolean(MeteoChartSOSB.class, MeteoChartSOSB.DEFAULT_VALUE)) {
