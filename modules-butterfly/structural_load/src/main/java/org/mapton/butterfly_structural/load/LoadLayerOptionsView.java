 ...
 */
public class LoadLayerOptionsView extends BLayerOptionsView {

    private final SessionComboBox<LoadColorBy> mColorScb = new SessionComboBox<>();
    private final SessionCheckComboBox<GraphicItem> mGraphicSccb = new SessionCheckComboBox<>();
    private final LoadLayerOptions mLayerOptions = LoadLayerOptions.getInstance();
    private final SessionComboBox<LoadPointBy> mPointScb = new SessionComboBox<>();

    public LoadLayerOptionsView(LoadLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_LoadAction(), LoadLayerOptions.getInstance(), "load");
        createUI();
    ...
    private void createUI() {
        ...
        mColorScb.getItems().setAll(LoadColorBy.values());
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), LoadLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(LoadLabelBy.class, mLayerOptions.labelByProperty().get().name(), LoadLayerOptions.DEFAULT_LABEL_BY));
...
//        activateAnnotation();
    ...
    private void initListerners() {
        mLayerOptions.labelByOperationProperty().addListener((p, o, n) -> {
            ...
            for (var labelBy : LoadLabelBy.values()) {
