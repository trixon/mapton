...
public class LoadView {
    ...
    private final MPresetPopOver mPresetPopOver = new MPresetPopOver(mFilterPopOver, MPresetPopOver.PARENT_NODE_FILTER, "load");
    ...
    public LoadView() {
        ...
        mListForm.getListView().setCellFactory(listView -> new LoadListCell());
