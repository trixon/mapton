 ...
 */
public class LoadLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static LoadLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private LoadLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final LoadLayerOptions INSTANCE = new LoadLayerOptions();
    }
}
