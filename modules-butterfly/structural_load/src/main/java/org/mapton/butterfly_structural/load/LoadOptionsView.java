...
public class LoadOptionsView extends BOptionsView {
    ...
    private final LoadOptions mOptions = LoadOptions.getInstance();
    ...
    public LoadOptionsView(LoadLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_LoadAction(), LoadOptions.getInstance(), "load");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mOptions.labelByOperationProperty(), LoadLabelBy.values());
        mLabelMenuButton.setText(mOptions.getLabelFromId(LoadLabelBy.class, mOptions.labelByProperty().get().name(), LoadOptions.DEFAULT_LABEL_BY));
