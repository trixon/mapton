...
//        return MathHelper.convertDoubleToString(p.getZ(), 1);
    ...
    private final Function<BVattenkemi, String> mFunction;
    private final String mName;

    private VattenkemiLabelBy(String category, String name, Function<BVattenkemi, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BVattenkemi o) {
