 ...
 */
public class VattenkemiFilterPopOver extends BaseFilterPopOver {

    private final VattenkemiFilter mFilter;
    ...
    public VattenkemiFilterPopOver(VattenkemiFilter filter) {
        mFilter = filter;
        createUI();
        initListeners();
        initSession();
    ...
    public void load(Butterfly butterfly) {
        var grundvatten = butterfly.tmo().getVattenkemi();
