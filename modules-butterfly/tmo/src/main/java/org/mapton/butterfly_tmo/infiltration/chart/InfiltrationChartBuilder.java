 ...
 */
package org.mapton.butterfly_tmo.infiltration.chart;
 ...
 */
public class InfiltrationChartBuilder extends ChartBuilder<BInfiltration> {
    ...
    private final TimeSeries mTimeSeriesH = new TimeSeries("Medelflöde");

    public InfiltrationChartBuilder() {
        initChart();
    }

    @Override
    public synchronized Callable<ChartPanel> build(BInfiltration p) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public void setTitle(BInfiltration p) {
        mChart.setTitle(p.getName());
    }

    @Override
    public void updateDataset(BInfiltration p) {
