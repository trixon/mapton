 ...
 */
public class InfiltrationLayerOptionsView extends BLayerOptionsView {
    ...
    public InfiltrationLayerOptionsView(InfiltrationLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_InfiltrationAction(), InfiltrationLayerOptions.getInstance(), "infiltration");
        setDefaultId(InfiltrationLayerOptions.DEFAULT_LABEL_BY);
...
//        activateAnnotation();
    ...
    private void initSession() {
        ...
        restoreLabelFromId(InfiltrationLabelBy.class, mLayerOptions.labelByProperty().get().name(), InfiltrationLayerOptions.DEFAULT_LABEL_BY);
