 ...
 */
@ConvertAsProperties(
        dtd = "-//org.mapton.butterfly-tmo//Infiltration//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "InfiltrationTopComponent",
...
@Messages({
    "CTL_InfiltrationAction=Infiltration"
})
public final class InfiltrationTopComponent extends MTopComponent {

    public InfiltrationTopComponent() {
        setName(Bundle.CTL_InfiltrationAction());
    }
