 ...
 */
public class VaderstationAttributeManager extends BaseAttributeManager {
    ...
    public static VaderstationAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private VaderstationAttributeManager() {
    }
    ...
    private static class Holder {
        ...
        private static final VaderstationAttributeManager INSTANCE = new VaderstationAttributeManager();
    }
}
