 ...
 */
public class VattenkemiFilter extends FormFilter<VattenkemiManager> {

    private IndexedCheckModel mGroupCheckModel;
    private final VattenkemiManager mManager = VattenkemiManager.getInstance();

    public VattenkemiFilter() {
        super(VattenkemiManager.getInstance());
    ...
    private boolean validateFreeText(BVattenkemi b) {
