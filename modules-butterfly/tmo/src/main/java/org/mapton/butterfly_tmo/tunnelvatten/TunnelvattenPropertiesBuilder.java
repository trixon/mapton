 ...
 */
public class TunnelvattenPropertiesBuilder extends PropertiesBuilder<BTunnelvatten> {

    @Override
    public Object build(BTunnelvatten p) {
        if (p == null) {
            return p;
        }
...
//        propertyMap.put(getCatKey(cat1, ""), p.get);
//        if (p instanceof BTunnelvatten g) {
//            propertyMap.put(getCatKey(cat1, "Typ"), g.getTunnelvattenstyp());
...
//                propertyMap.put(getCatKey(cat1, "Senaste"), TunnelvattenHelper.getLevelAndDate(g.ext().getObservationRawLast()));
//                propertyMap.put(getCatKey(cat1, "Första"), TunnelvattenHelper.getLevelAndDate(g.ext().getObservationRawFirst()));
