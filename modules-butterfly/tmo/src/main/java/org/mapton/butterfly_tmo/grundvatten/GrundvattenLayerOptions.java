 ...
 */
public class GrundvattenLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static GrundvattenLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private GrundvattenLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final GrundvattenLayerOptions INSTANCE = new GrundvattenLayerOptions();
    }
}
