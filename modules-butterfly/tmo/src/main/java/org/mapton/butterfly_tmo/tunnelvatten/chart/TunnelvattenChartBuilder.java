 ...
 */
package org.mapton.butterfly_tmo.tunnelvatten.chart;
 ...
 */
public class TunnelvattenChartBuilder extends ChartBuilder<BTunnelvatten> {
    ...
    private final TimeSeries mTimeSeriesH = new TimeSeries("Momentant flöde");

    public TunnelvattenChartBuilder() {
        initChart();
    }

    @Override
    public synchronized Callable<ChartPanel> build(BTunnelvatten p) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public void setTitle(BTunnelvatten p) {
        mChart.setTitle(p.getName());
    }

    @Override
    public void updateDataset(BTunnelvatten p) {
        ...
        p.ext().getObservationsTimeFiltered().forEach(o -> {
            ...
            mTimeSeriesH.addOrUpdate(minute, o.getValue());
