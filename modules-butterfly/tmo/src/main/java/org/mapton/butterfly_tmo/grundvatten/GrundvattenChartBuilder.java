...
public class GrundvattenChartBuilder extends ChartBuilder<BGrundvatten> {
    ...
    public GrundvattenChartBuilder() {
        initChart();
    }

    @Override
    public synchronized Callable<ChartPanel> build(BGrundvatten p) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public void setTitle(BGrundvatten p) {
        mChart.setTitle(p.getName());
    }

    @Override
    public void updateDataset(BGrundvatten p) {
