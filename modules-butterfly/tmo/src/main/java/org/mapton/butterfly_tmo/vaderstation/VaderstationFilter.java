 ...
 */
public class VaderstationFilter extends FormFilter<VaderstationManager> {

    private IndexedCheckModel mGroupCheckModel;
    private final VaderstationManager mManager = VaderstationManager.getInstance();

    public VaderstationFilter() {
        super(VaderstationManager.getInstance());
    ...
    private boolean validateFreeText(BVaderstation b) {
