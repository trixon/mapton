 ...
 */
public enum TunnelvattenLabelBy implements LabelBy.Operations {
...
//        return MathHelper.convertDoubleToString(p.getZ(), 1);
    ...
    private final Function<BTunnelvatten, String> mFunction;
    private final String mName;

    private TunnelvattenLabelBy(String category, String name, Function<BTunnelvatten, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BTunnelvatten o) {
