 ...
 */
public class TunnelvattenAttributeManager extends BaseAttributeManager {
    ...
    public static TunnelvattenAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private TunnelvattenAttributeManager() {
    }
    ...
    private static class Holder {
        ...
        private static final TunnelvattenAttributeManager INSTANCE = new TunnelvattenAttributeManager();
    }
}
