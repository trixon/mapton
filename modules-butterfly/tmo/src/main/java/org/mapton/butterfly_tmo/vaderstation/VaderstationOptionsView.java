 ...
 */
public class VaderstationOptionsView extends MOptionsView<VaderstationLayerBundle> {
    ...
    public VaderstationLabelBy getLabelBy() {
    ...
    public SimpleObjectProperty<VaderstationLabelBy> labelByProperty() {
    ...
    private void populateLabelMenuButton() {
        ...
        for (var topoLabel : VaderstationLabelBy.values()) {
