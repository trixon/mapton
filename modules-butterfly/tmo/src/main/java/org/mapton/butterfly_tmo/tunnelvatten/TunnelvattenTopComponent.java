 ...
 */
@ConvertAsProperties(
        dtd = "-//org.mapton.butterfly-tmo//Tunnelvatten//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "TunnelvattenTopComponent",
...
@Messages({
    "CTL_TunnelvattenAction=Tunnelvatten"
})
public final class TunnelvattenTopComponent extends MTopComponent {

    public TunnelvattenTopComponent() {
