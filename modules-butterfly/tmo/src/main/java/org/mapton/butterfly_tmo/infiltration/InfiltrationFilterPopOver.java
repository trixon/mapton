 ...
 */
public class InfiltrationFilterPopOver extends BaseFilterPopOver {

    private final InfiltrationFilter mFilter;
    ...
    public InfiltrationFilterPopOver(InfiltrationFilter filter) {
        mFilter = filter;
        createUI();
        initListeners();
        initSession();
