 ...
 */
public class VaderstationFilterPopOver extends BaseFilterPopOver {

    private final VaderstationFilter mFilter;
    ...
    public VaderstationFilterPopOver(VaderstationFilter filter) {
        mFilter = filter;
        createUI();
        initListeners();
        initSession();
    ...
    public void load(Butterfly butterfly) {
        var grundvatten = butterfly.tmo().getVaderstation();
    ...
    private void initSession() {
        ...
        sessionManager.register("filter.vaderstation.freeText", mFilter.freeTextProperty());
        sessionManager.register("filter.vaderstation.checkedGroup", mGroupCheckModelSession.checkedStringProperty());
