 ...
 */
public class TunnelvattenLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static TunnelvattenLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private TunnelvattenLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final TunnelvattenLayerOptions INSTANCE = new TunnelvattenLayerOptions();
    }
}
