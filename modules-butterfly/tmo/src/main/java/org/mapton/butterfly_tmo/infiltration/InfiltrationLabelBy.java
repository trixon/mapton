 ...
 */
public enum InfiltrationLabelBy implements LabelBy.Operations {
...
//        return MathHelper.convertDoubleToString(p.getZ(), 1);
    ...
    private final Function<BInfiltration, String> mFunction;
    private final String mName;

    private InfiltrationLabelBy(String category, String name, Function<BInfiltration, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BInfiltration o) {
