 ...
 */
public class InfiltrationLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static InfiltrationLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private InfiltrationLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final InfiltrationLayerOptions INSTANCE = new InfiltrationLayerOptions();
    }
}
