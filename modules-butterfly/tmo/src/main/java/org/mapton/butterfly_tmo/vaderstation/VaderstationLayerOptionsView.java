 ...
 */
public class VaderstationLayerOptionsView extends BLayerOptionsView {
    ...
    public VaderstationLayerOptionsView(VaderstationLayerBundle layerBundle) {
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, labelByProperty(), VaderstationLabelBy.values());
    ...
    private void initSession() {
        ...
        sessionManager.register("options.vaderstation.labelBy", labelByIdProperty());

        restoreLabelFromId(VaderstationLabelBy.class, DEFAULT_LABEL_BY);
    }
}
