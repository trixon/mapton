 ...
 */
public class GrundvattenContentView {
    ...
    public GrundvattenContentView() {
        ...
        mListForm = new SingleListForm<>(mManager, Bundle.CTL_GrundvattenAction());
        ...
        mListForm.getListView().setCellFactory(listView -> new GrundvattenContentListCell());
