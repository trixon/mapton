 ...
 */
public class VattenkemiAttributeManager extends BaseAttributeManager {
    ...
    public static VattenkemiAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private VattenkemiAttributeManager() {
    }
    ...
    private static class Holder {
        ...
        private static final VattenkemiAttributeManager INSTANCE = new VattenkemiAttributeManager();
    }
}
