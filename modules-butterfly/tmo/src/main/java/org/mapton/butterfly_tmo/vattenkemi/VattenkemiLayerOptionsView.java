 ...
 */
public class VattenkemiLayerOptionsView extends BLayerOptionsView {
    ...
    public VattenkemiLayerOptionsView(VattenkemiLayerBundle layerBundle) {
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, labelByProperty(), VattenkemiLabelBy.values());
    ...
    private void initSession() {
        ...
        sessionManager.register("options.vattenkemi.labelBy", labelByIdProperty());

        restoreLabelFromId(VattenkemiLabelBy.class, DEFAULT_LABEL_BY);
    }
}
