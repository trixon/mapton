...
public class CrackOptionsView extends BOptionsView {
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mOptions.labelByOperationProperty(), CrackLabelBy.values());
        mLabelMenuButton.setText(mOptions.getLabelFromId(CrackLabelBy.class, mOptions.labelByProperty().get().name(), CrackOptions.DEFAULT_LABEL_BY));
