 ...
 */
public class CrackLayerOptionsView extends BLayerOptionsView {
    ...
    private final CrackLayerOptions mLayerOptions = CrackLayerOptions.getInstance();
    private final SessionComboBox<CrackPointBy> mPointScb = new SessionComboBox<>();

    public CrackLayerOptionsView(CrackLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_CrackAction(), CrackLayerOptions.getInstance(), "crack");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), CrackLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(CrackLabelBy.class, mLayerOptions.labelByProperty().get().name(), CrackLayerOptions.DEFAULT_LABEL_BY));
