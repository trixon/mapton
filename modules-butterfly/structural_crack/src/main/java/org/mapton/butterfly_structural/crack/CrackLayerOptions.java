 ...
 */
public class CrackLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static CrackLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private CrackLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final CrackLayerOptions INSTANCE = new CrackLayerOptions();
    }
}
