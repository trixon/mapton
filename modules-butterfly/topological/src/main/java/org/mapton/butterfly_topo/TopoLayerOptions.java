 ...
 */
public class TopoLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static TopoLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private TopoLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final TopoLayerOptions INSTANCE = new TopoLayerOptions();
    }
}
