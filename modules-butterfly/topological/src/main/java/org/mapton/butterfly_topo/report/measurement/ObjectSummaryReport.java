...
public class ObjectSummaryReport extends BaseTopoMeasurementReport {

    private final TopoManager mManager = TopoManager.getInstance();
    private final String mName = "Objektsammanställning";

    public ObjectSummaryReport() {
        setName(mName);
    }
    ...
    public ContainerTag getContent() {
        ...
        addRow(rows, "Datum", LocalDate.now().toString());
        ...
        addRow(rows, "Största rörelser", "Punkt", "Rörelse", "Larmnivå");
        addRow(rows, "Dubbar");
        addBlankRow(rows);
        addRow(rows, "Prismor");
