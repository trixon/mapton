 ...
 */
public class GradeVFavoritePopOver extends BaseFilterFavoritePopOver<GradeVFilterFavorite> {

    public GradeVFavoritePopOver(BaseFilterPopOver filterPopOver) {
        super(GradeVFilterFavorite.class, filterPopOver);
...
//        mEditableList.getListView().setItems(mManager.itemsProperty(getClass()));
    ...
    @Override
    public void onEdit(String title, GradeVFilterFavorite filterFavorite) {
        if (filterFavorite == null) {
            filterFavorite = new GradeVFilterFavorite();
        }
