 ...
 */
public class HeightPairFilterPopOver extends BaseTabbedFilterPopOver {

    private final HeightPairFilter mFilter;
...
//    private final GradeManagerBase mManager;
    ...
    public HeightPairFilterPopOver(HeightPairFilter filter) {
