...
import org.mapton.butterfly_topo.grade.distance.graphic.GraphicItem;
...
public class DistanceOptionsView extends BOptionsView {
    ...
    private static final DistanceLabelBy DEFAULT_LABEL_BY = DistanceLabelBy.NAME;
    ...
    public DistanceOptionsView(DistanceLayerBundle layerBundle) {
        super(layerBundle, NbBundle.getMessage(GradeManagerBase.class, "grade_d"));
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, labelByProperty(), DistanceLabelBy.values());
...
//        mPlotPointProperty.bind(mPointTab.disabledProperty().not());
    ...
    private void initSession() {
        ...
        restoreLabelFromId(DistanceLabelBy.class, DEFAULT_LABEL_BY);
    }
}
