 ...
 */
public class GradeHLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static GradeHLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private GradeHLayerOptions() {
        ...
        setPreferences(getPreferencesForPath("GradeH"));
        disablePlotDebt();
    }
    ...
    private static class Holder {
        ...
        private static final GradeHLayerOptions INSTANCE = new GradeHLayerOptions();
    }
}
