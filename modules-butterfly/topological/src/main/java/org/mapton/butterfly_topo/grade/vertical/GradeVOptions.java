 ...
 */
public class GradeVOptions extends BOptionsBase implements MPresetActions {
    ...
    public static GradeVOptions getInstance() {
        return Holder.INSTANCE;
    }

    private GradeVOptions() {
    ...
    private static class Holder {
        ...
        private static final GradeVOptions INSTANCE = new GradeVOptions();
    }
}
