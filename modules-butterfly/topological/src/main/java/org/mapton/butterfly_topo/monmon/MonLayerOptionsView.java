 ...
 */
public class MonLayerOptionsView extends BLayerOptionsView {

    private final SessionComboBox<MonColorBy> mColorScb = new SessionComboBox<>();
    ...
    private final SessionComboBox<MonPointBy> mPointScb = new SessionComboBox<>();

    public MonLayerOptionsView(MonLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_MonmonAction(), MonLayerOptions.getInstance(), "mon");
        createUI();
    ...
    private void createUI() {
        mPointScb.getItems().setAll(MonPointBy.values());
        mColorScb.getItems().setAll(MonColorBy.values());
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), MonLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(MonLabelBy.class, mLayerOptions.labelByProperty().get().name(), MonLayerOptions.DEFAULT_LABEL_BY));
...
//        activateAnnotation();
    ...
    private void initListerners() {
        mLayerOptions.labelByOperationProperty().addListener((p, o, n) -> {
            ...
            for (var labelBy : MonLabelBy.values()) {
