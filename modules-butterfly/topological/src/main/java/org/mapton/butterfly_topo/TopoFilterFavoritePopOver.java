 ...
 */
public class TopoFilterFavoritePopOver extends BaseFilterFavoritePopOver<TopoFilterFavorite> {

    public TopoFilterFavoritePopOver(BaseFilterPopOver filterPopOver) {
        super(TopoFilterFavorite.class, filterPopOver);
...
//        mEditableList.getListView().setItems(mManager.itemsProperty(getClass()));
    ...
    @Override
    public void onEdit(String title, TopoFilterFavorite filterFavorite) {
        if (filterFavorite == null) {
            filterFavorite = new TopoFilterFavorite();
        }
