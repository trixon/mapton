 ...
 */
public class HeightPairPropertiesBuilder extends PropertiesBuilder<BTopoHeightPair> {

    protected final ResourceBundle mBundle = NbBundle.getBundle(HeightPairManager.class);

    @Override
    public Object build(BTopoHeightPair p) {
        if (p == null) {
            return p;
        }
