 ...
 */
public class GradeVLayerOptionsView extends BLayerOptionsView {
    ...
    private final GradeVLayerOptions mLayerOptions = GradeVLayerOptions.getInstance();
    private final SessionComboBox<GradePointBy> mPointScb = new SessionComboBox<>();

    public GradeVLayerOptionsView(GradeVLayerBundle layerBundle) {
        super(layerBundle, NbBundle.getMessage(GradeManagerBase.class, "grade_v"), GradeVLayerOptions.getInstance(), "gradeH");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), GradeVLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(GradeVLabelBy.class, mLayerOptions.labelByProperty().get().name(), GradeVLayerOptions.DEFAULT_LABEL_BY));
