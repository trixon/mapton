 ...
 */
public class GradeHFavoritePopOver extends BaseFilterFavoritePopOver<GradeHFilterFavorite> {

    public GradeHFavoritePopOver(BaseFilterPopOver filterPopOver) {
        super(GradeHFilterFavorite.class, filterPopOver);
...
//        mEditableList.getListView().setItems(mManager.itemsProperty(getClass()));
    ...
    @Override
    public void onEdit(String title, GradeHFilterFavorite filterFavorite) {
        if (filterFavorite == null) {
            filterFavorite = new GradeHFilterFavorite();
        }
