 ...
 */
public class GradeHLayerOptionsView extends BLayerOptionsView {
    ...
    private final GradeHLayerOptions mLayerOptions = GradeHLayerOptions.getInstance();
    private final SessionComboBox<GradePointBy> mPointScb = new SessionComboBox<>();

    public GradeHLayerOptionsView(GradeHLayerBundle layerBundle) {
        super(layerBundle, NbBundle.getMessage(GradeManagerBase.class, "grade_h"), GradeHLayerOptions.getInstance(), "gradeH");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), GradeHLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(GradeHLabelBy.class, mLayerOptions.labelByProperty().get().name(), GradeHLayerOptions.DEFAULT_LABEL_BY));
