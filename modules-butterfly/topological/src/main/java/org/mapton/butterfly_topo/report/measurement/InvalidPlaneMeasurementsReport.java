...
public class InvalidPlaneMeasurementsReport extends BaseTopoMeasurementReport {

    private final TopoManager mManager = TopoManager.getInstance();
    private final String mName = "Ogiltiga mätningar i plan";

    public InvalidPlaneMeasurementsReport() {
        setName(mName);
    }
        ...
        mManager.getTimeFilteredItems().stream()
                ...
                .forEachOrdered(p -> {
                    for (var o : p.ext().getObservationsTimeFiltered()) {
                        if (ObjectUtils.anyNull(o.getMeasuredX(), o.getMeasuredY())) {
