 ...
 */
@ConvertAsProperties(
        dtd = "-//org.mapton.butterfly-topo//Distance//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "DistanceTopComponent",
...
@Messages({
    "CTL_DistanceAction=Control points, distance"
})
public final class DistanceTopComponent extends MTopComponent {

    private final ResourceBundle mBundle = NbBundle.getBundle(GradeManagerBase.class);

    public DistanceTopComponent() {
        setName(mBundle.getString("grade_d"));
    }
    ...
    private Scene createScene() {
        var gradeView = new DistanceView();
