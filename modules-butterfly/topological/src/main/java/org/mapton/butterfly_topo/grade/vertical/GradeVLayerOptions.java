 ...
 */
public class GradeVLayerOptions extends BLayerOptions implements MPresetActions {

    public static final GradeVColorBy DEFAULT_COLOR_BY = GradeVColorBy.DEFAULT;
    public static final GradeVLabelBy DEFAULT_LABEL_BY = GradeVLabelBy.NAME;
    public static final GradePointBy DEFAULT_POINT_BY = GradePointBy.PIN;
    private final ObjectProperty<GradeVColorBy> mColorByProperty = new SimpleObjectProperty<>(DEFAULT_COLOR_BY);
    private final ObjectProperty<GradeVLabelBy> mLabelByProperty = new SimpleObjectProperty<>(DEFAULT_LABEL_BY);
    private final ObjectProperty<GradePointBy> mPointByProperty = new SimpleObjectProperty<>(DEFAULT_POINT_BY);

    public static GradeVLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private GradeVLayerOptions() {
        ...
        setPreferences(getPreferencesForPath("GradeV"));
        disablePlotDebt();
    }
    ...
    public GradeVColorBy getColorBy() {
    ...
    public ObjectProperty<GradeVLabelBy> labelByProperty() {
    ...
    private static class Holder {
        ...
        private static final GradeVLayerOptions INSTANCE = new GradeVLayerOptions();
    }
}
