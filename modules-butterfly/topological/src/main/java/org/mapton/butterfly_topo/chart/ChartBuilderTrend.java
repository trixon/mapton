...
public class ChartBuilderTrend extends ChartBuilderBase {
    ...
    public void updateDataset(BTopoControlPoint p) {
        ...
        if (startDateFirst.isBefore(startDateZero)) {
            plot(p, "Första", startDateFirst, LocalDateTime.MIN, Color.BLACK, index++);
        }
    ...
    private void plot(BTopoControlPoint p, String title, LocalDateTime startDate, LocalDateTime limitDate, Color color, int index) {
        ...
        renderer.setDefaultOutlineStroke(new BasicStroke(4f));
