 ...
 */
public class MultiChartBuilder extends XyzChartBuilder<BStructuralStrainGaugePoint> {
    ...
    public synchronized Callable<ChartPanel> build(BStructuralStrainGaugePoint p, BMultiChartPart multiChartComponent) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public Object build(BStructuralStrainGaugePoint selectedObject) {
    ...
    @Override
    public void setTitle(BStructuralStrainGaugePoint b) {
