...
public class ChartBuilderTrend extends ChartBuilderBase {
    ...
    public ChartBuilderTrend(BDimension dimension, Function<BXyzPointObservation, Double> function) {
        ...
        mFunction = function;
        mTimeSeries = new TimeSeries("Töjning");
        initChart("Δ µε", "0");
    }
    ...
    private void plot(BStructuralStrainGaugePoint p, String title, LocalDateTime startDate, LocalDateTime limitDate, Color color, int index, Integer percentile) {
