 ...
 */
public class StrainLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static StrainLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private StrainLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final StrainLayerOptions INSTANCE = new StrainLayerOptions();
    }
}
