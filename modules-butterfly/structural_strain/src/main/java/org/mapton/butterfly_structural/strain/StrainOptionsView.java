...
public class StrainOptionsView extends BOptionsView {
    ...
    public StrainOptionsView(StrainLayerBundle layerBundle) {
        ...
        setDefaultId(StrainOptions.DEFAULT_LABEL_BY);
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, labelByProperty(), StrainLabelBy.values());
    ...
    private void initSession() {
        ...
        restoreLabelFromId(StrainLabelBy.class, mOptions.labelByProperty().get().name(), StrainOptions.DEFAULT_LABEL_BY);
