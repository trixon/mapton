 ...
 */
public class BlastLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static BlastLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private BlastLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final BlastLayerOptions INSTANCE = new BlastLayerOptions();
    }
}
