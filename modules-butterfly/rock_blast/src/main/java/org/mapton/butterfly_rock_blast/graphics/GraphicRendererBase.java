...
import org.mapton.butterfly_rock_blast.BlastManager;

/**
 *
 * @author Patrik Karlström
 */
public abstract class GraphicRendererBase extends BaseGraphicRenderer<GraphicItem, BRockBlast> {
    ...
    protected static HashMap<BRockBlast, Position[]> sPointToPositionMap = new HashMap<>();
    protected final BlastAttributeManager mAttributeManager = BlastAttributeManager.getInstance();
    protected final BlastManager mManager = BlastManager.getInstance();
    ...
    protected boolean isPlotLimitReached(BRockBlast p, Object key, Position position) {
