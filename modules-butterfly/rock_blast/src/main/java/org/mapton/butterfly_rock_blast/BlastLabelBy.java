...
public enum BlastLabelBy implements LabelBy.Operations {
    ...
    private final Function<BRockBlast, String> mFunction;
    private final String mName;

    private BlastLabelBy(String category, String name, Function<BRockBlast, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BRockBlast o) {
        try {
