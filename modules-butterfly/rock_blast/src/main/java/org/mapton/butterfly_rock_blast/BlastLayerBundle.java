...
import org.mapton.butterfly_rock_blast.graphics.GraphicRenderer;
...
public class BlastLayerBundle extends BfLayerBundle {
    ...
    private final BlastLayerOptionsView mLayerOptionsView;
    private final BlastManager mManager = BlastManager.getInstance();

    public BlastLayerBundle() {
        init();
        initRepaint();
        mLayerOptionsView = new BlastLayerOptionsView(this);
    ...
    private PointPlacemark plotLabel(BRockBlast p, BlastLabelBy labelBy, Position position) {
    ...
    private PointPlacemark plotPin(BRockBlast p, Position position, PointPlacemark labelPlacemark) {
