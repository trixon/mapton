...
public class BlastOptionsView extends BOptionsView {
    ...
    public BlastOptionsView(BlastLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_BlastAction(), BlastOptions.getInstance(), "blast");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mOptions.labelByOperationProperty(), BlastLabelBy.values());
        mLabelMenuButton.setText(mOptions.getLabelFromId(BlastLabelBy.class, mOptions.labelByProperty().get().name(), BlastOptions.DEFAULT_LABEL_BY));
