...
import org.mapton.butterfly_rock_blast.graphics.GraphicItem;
 ...
 */
public class BlastLayerOptionsView extends BLayerOptionsView {

    private final SessionComboBox<BlastColorBy> mColorScb = new SessionComboBox<>();
    ...
    private final SessionComboBox<BlastPointBy> mPointScb = new SessionComboBox<>();

    public BlastLayerOptionsView(BlastLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_BlastAction(), BlastLayerOptions.getInstance(), "blast");
        createUI();
    ...
    private void createUI() {
        mPointScb.getItems().setAll(BlastPointBy.values());
        mColorScb.getItems().setAll(BlastColorBy.values());
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), BlastLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(BlastLabelBy.class, mLayerOptions.labelByProperty().get().name(), BlastLayerOptions.DEFAULT_LABEL_BY));
    ...
    private void initListerners() {
        mLayerOptions.labelByOperationProperty().addListener((p, o, n) -> {
            ...
            for (var labelBy : BlastLabelBy.values()) {
