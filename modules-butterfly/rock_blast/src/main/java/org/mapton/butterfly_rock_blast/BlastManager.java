...
import org.mapton.butterfly_rock_blast.chart.BlastMultiChartAggregate;
...
public class BlastManager extends BaseManager<BRockBlast> {
    ...
    @Override
    public Object getObjectChart(BRockBlast selectedObject) {
        return mMultiChartAggregate.build(selectedObject);
    }

    @Override
    public Object getObjectProperties(BRockBlast selectedObject) {
    ...
    public void load(Butterfly butterfly) {
        try {
            initAllItems(butterfly.rock().getBlasts());
    ...
    @Override
    protected void load(ArrayList<BRockBlast> items) {
