...
public class MonOptionsView extends BOptionsView {
    ...
    public MonOptionsView(MonLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_MonmonAction(), MonOptions.getInstance(), "mon");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mOptions.labelByOperationProperty(), MonLabelBy.values());
        mLabelMenuButton.setText(mOptions.getLabelFromId(MonLabelBy.class, mOptions.labelByProperty().get().name(), MonOptions.DEFAULT_LABEL_BY));
