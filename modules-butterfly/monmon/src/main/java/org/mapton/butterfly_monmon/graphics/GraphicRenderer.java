...
public class GraphicRenderer {
    ...
    public void plot(BMonmon mon, Position position, int stationIndex, HashMap<String, Double> pointToZ, ArrayList<AVListImpl> mapObjects) {
        ...
        if (mon.isChild()) {
            ...
            boolean checked1 = mCheckModel.isChecked(GraphicItem.LATEST_1);
            boolean checked7 = mCheckModel.isChecked(GraphicItem.LATEST_7);
            boolean checked14 = mCheckModel.isChecked(GraphicItem.LATEST_14);
