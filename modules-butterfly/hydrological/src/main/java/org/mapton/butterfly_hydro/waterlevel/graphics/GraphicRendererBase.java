 ...
 */
public abstract class GraphicRendererBase extends BaseGraphicRenderer<GraphicItem, BHydroWaterLevelPoint> {
    ...
    protected boolean isPlotLimitReached(BHydroWaterLevelPoint p, Object key, Position position) {
