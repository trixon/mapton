 ...
 */
public abstract class ChartBuilderBase extends XyzChartBuilder<BHydroWaterLevelPoint> {

    protected Minute mSubSetLastMinute;
    protected Minute mSubSetZeroMinute;
    protected final TimeSeries mTimeSeries1d = new TimeSeries("Nivå");
    ...
    @Override
    public synchronized Callable<ChartPanel> build(BHydroWaterLevelPoint p) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public void setTitle(BHydroWaterLevelPoint p) {
