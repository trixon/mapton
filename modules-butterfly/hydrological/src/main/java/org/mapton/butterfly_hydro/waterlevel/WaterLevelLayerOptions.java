 ...
 */
public class WaterLevelLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static WaterLevelLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private WaterLevelLayerOptions() {
        ...
        setPreferences(getPreferencesForPath("WaterLevel"));
    }
    ...
    private static class Holder {
        ...
        private static final WaterLevelLayerOptions INSTANCE = new WaterLevelLayerOptions();
    }
}
