...
import org.mapton.butterfly_hydro.waterlevel.graphics.GraphicRenderer;
...
public class WaterLevelLayerBundle extends BfLayerBundle {
    ...
    private PointPlacemark plotLabel(BHydroWaterLevelPoint p, WaterLevelLabelBy labelBy, Position position) {
        if (labelBy == WaterLevelLabelBy.NONE) {
            return null;
        } else {
    ...
    private PointPlacemark plotPin(BHydroWaterLevelPoint p, Position position, PointPlacemark labelPlacemark) {
