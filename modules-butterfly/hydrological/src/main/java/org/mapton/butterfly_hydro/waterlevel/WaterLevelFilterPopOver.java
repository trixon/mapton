 ...
 */
public class WaterLevelFilterPopOver extends BaseTabbedFilterPopOver {

    private final WaterLevelFilter mFilter;
    ...
    public void load(Butterfly butterfly) {
        var items = butterfly.hydro().getWaterLevelPoints();
