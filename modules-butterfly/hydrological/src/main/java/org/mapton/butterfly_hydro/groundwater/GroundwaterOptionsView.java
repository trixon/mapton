 ...
 */
public class GroundwaterOptionsView extends MOptionsView {
    ...
    private final SimpleObjectProperty<GroundwaterLabelBy> mLabelByProperty = new SimpleObjectProperty<>();
    ...
    public SimpleObjectProperty<GroundwaterLabelBy> labelByProperty() {
    ...
    private void initSession() {
        ...
        sessionManager.register("options.groundwater.labelBy", mLabelByIdProperty);
        sessionManager.register("options.groundwater.checkedGraphics", mGraphicSccb.checkedStringProperty());

        try {
            mLabelByProperty.set(GroundwaterLabelBy.valueOf(mLabelByIdProperty.get()));
        } catch (IllegalArgumentException e) {
            mLabelByProperty.set(GroundwaterLabelBy.NAME);
        }
    }
    ...
    private void populateLabelMenuButton() {
        ...
        for (var topoLabel : GroundwaterLabelBy.values()) {
