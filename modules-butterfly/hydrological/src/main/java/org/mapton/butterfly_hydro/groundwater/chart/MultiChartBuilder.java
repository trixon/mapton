 ...
 */
public class MultiChartBuilder extends XyzChartBuilder<BHydroGroundwaterPoint> {
    ...
    public synchronized Callable<ChartPanel> build(BHydroGroundwaterPoint p, BMultiChartPart multiChartComponent) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public Object build(BHydroGroundwaterPoint selectedObject) {
    ...
    @Override
    public void setTitle(BHydroGroundwaterPoint b) {
