 ...
 */
package org.mapton.butterfly_hydro.groundwater.table;
 ...
 */
public class StandardMeasurementPopulator extends BMeasurementBasePopulator<BHydroGroundwaterPoint> {
    ...
    @Override
    public void populate(BHydroGroundwaterPoint p) {
