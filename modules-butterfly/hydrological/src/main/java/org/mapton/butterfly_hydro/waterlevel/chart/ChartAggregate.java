...
//        final Function<BHydroWaterLevelPointObservation, Double> func1d = (var o) -> o.getGroundwaterLevel();
//        mBuilderTrend1d = new ChartBuilderTrend(BDimension._1d, func1d);

        mTabbedPane = new JTabbedPane(JTabbedPane.BOTTOM);
    }

    public synchronized Callable<JTabbedPane> build(BHydroWaterLevelPoint p) {
        if (p == null) {
            return null;
        }
