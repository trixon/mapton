 ...
 */
public class GroundwaterLayerOptionsView extends BLayerOptionsView {
    ...
    public GroundwaterLayerOptionsView(GroundwaterLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_GroundwaterAction(), GroundwaterLayerOptions.getInstance(), "groundwater");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), GroundwaterLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(GroundwaterLabelBy.class, mLayerOptions.labelByProperty().get().name(), GroundwaterLayerOptions.DEFAULT_LABEL_BY));
