...
public class ChartBuilderTrend extends ChartBuilderBase {
    ...
    private final Function<BHydroGroundwaterPointObservation, Double> mFunction;
    private final TimeSeries mTimeSeries;

    public ChartBuilderTrend(BDimension dimension, Function<BHydroGroundwaterPointObservation, Double> function) {
...
//        setRange(1.05, p.ext().getAlarm(BComponent.PLANE), p.ext().getAlarm(BComponent.HEIGHT));
    ...
    private void plot(BHydroGroundwaterPoint p, String title, LocalDateTime startDate, LocalDateTime limitDate, Color color, int index, Integer percentile) {
