 ...
 */
public enum WaterLevelLabelBy implements LabelBy.Operations {
    ...
    private final Function<BHydroWaterLevelPoint, String> mFunction;
    private final String mName;

    private WaterLevelLabelBy(String category, String name, Function<BHydroWaterLevelPoint, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BHydroWaterLevelPoint o) {
