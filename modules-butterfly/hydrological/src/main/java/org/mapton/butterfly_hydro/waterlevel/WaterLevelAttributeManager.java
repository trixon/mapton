 ...
 */
public class WaterLevelAttributeManager extends BaseAttributeManager {
    ...
    public static WaterLevelAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private WaterLevelAttributeManager() {
    }
...
//    }
    public PointPlacemarkAttributes getPinAttributes(BHydroWaterLevelPoint p) {
    ...
    public BasicShapeAttributes getTimeSeriesAttributes(BHydroWaterLevelPoint p) {
...
//        });
    ...
    private Color getColor(BHydroWaterLevelPoint grundvatten) {
    ...
    private static class Holder {
        ...
        private static final WaterLevelAttributeManager INSTANCE = new WaterLevelAttributeManager();
    }
}
