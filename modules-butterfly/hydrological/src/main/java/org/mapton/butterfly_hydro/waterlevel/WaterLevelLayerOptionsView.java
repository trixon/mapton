 ...
 */
public class WaterLevelLayerOptionsView extends BLayerOptionsView {
    ...
    public WaterLevelLayerOptionsView(WaterLevelLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_WaterLevelAction(), WaterLevelLayerOptions.getInstance(), "groundwater");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), WaterLevelLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(WaterLevelLabelBy.class, mLayerOptions.labelByProperty().get().name(), WaterLevelLayerOptions.DEFAULT_LABEL_BY));
