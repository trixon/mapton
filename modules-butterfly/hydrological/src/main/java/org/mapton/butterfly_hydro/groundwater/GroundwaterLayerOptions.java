 ...
 */
public class GroundwaterLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static GroundwaterLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private GroundwaterLayerOptions() {
        ...
        setPreferences(getPreferencesForPath("Groundwater"));
    }
    ...
    private static class Holder {
        ...
        private static final GroundwaterLayerOptions INSTANCE = new GroundwaterLayerOptions();
    }
}
