 ...
 */
package org.mapton.butterfly_hydro.waterlevel.table;
 ...
 */
public class StandardMeasurementPopulator extends BMeasurementBasePopulator<BHydroWaterLevelPoint> {
    ...
    @Override
    public void populate(BHydroWaterLevelPoint p) {
