 ...
 */
public class MultiChartBuilder extends XyzChartBuilder<BHydroWaterLevelPoint> {
    ...
    public synchronized Callable<ChartPanel> build(BHydroWaterLevelPoint p, BMultiChartPart multiChartComponent) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public Object build(BHydroWaterLevelPoint selectedObject) {
    ...
    @Override
    public void setTitle(BHydroWaterLevelPoint b) {
