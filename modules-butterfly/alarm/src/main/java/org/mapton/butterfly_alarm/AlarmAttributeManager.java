 ...
 */
public class AlarmAttributeManager extends BaseAttributeManager {
    ...
    public static AlarmAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private AlarmAttributeManager() {
    }
    ...
    private static class Holder {
        ...
        private static final AlarmAttributeManager INSTANCE = new AlarmAttributeManager();
    }
}
