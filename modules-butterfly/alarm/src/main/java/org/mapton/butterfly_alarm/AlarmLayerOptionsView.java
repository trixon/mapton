 ...
 */
public class AlarmLayerOptionsView extends BLayerOptionsView {

    private static final AlarmLabelBy DEFAULT_LABEL_BY = AlarmLabelBy.NONE;
    ...
    public AlarmLayerOptionsView(AlarmLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_AlarmAction());
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, labelByProperty(), AlarmLabelBy.values());
    ...
    private void initSession() {
        ...
        restoreLabelFromId(AlarmLabelBy.class, DEFAULT_LABEL_BY);
    }
}
