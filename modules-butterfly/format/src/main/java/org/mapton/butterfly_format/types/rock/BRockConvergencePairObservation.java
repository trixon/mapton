 ...
 */
public class BRockConvergencePairObservation {

    private final LocalDateTime mDate;
    private final Point3D mDelta;
    private final Point3D mO1;
    private final Point3D mO2;
    private final BRockConvergencePair mPair;

    public BRockConvergencePairObservation(BRockConvergencePair pair, LocalDateTime date, Point3D o1, Point3D o2) {
        mPair = pair;
        mDate = date;
        mO1 = o1;
        mO2 = o2;
    ...
    private BRockConvergencePairObservation getFirstObservation() {
