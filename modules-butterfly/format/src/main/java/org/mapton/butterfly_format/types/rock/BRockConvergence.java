 ...
 */
public class BRockConvergence extends BXyzPoint {
    ...
    public class Ext extends BXyzPoint.Ext<BRockConvergenceObservation> {
        ...
        private final ArrayList<BRockConvergencePair> mPairs = new ArrayList<>();
        ...
        public Double getDeltaValue(Function<BRockConvergenceObservation, Double> function) {
            var pair = getPairWithLargestDiff(function);
            if (pair == null) {
                return null;
            } else {
        ...
        public BRockConvergencePair getPairWithLargestDiff(Function<BRockConvergenceObservation, Double> function) {
            ...
            var maxDateOpt = observations.stream()
                    .map(BRockConvergenceObservation::getDate)
        ...
        public ArrayList<BRockConvergencePair> getPairs() {
            return mPairs;
        }

        public Stream<BRockConvergencePair> getPairsOrderedByDeltaDesc(Function<BRockConvergenceObservation, Double> function, Integer... limits) {
            int limit;
