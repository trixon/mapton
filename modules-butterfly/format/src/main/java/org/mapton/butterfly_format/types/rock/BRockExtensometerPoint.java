...
public class BRockExtensometerPoint extends BXyzPoint {
    ...
    public class Ext extends BXyzPoint.Ext<BRockExtensometerPointObservation> {
        ...
        public int getAlarmLevel(BRockExtensometerPointObservation o) {
            var p = BRockExtensometerPoint.this;
