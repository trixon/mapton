...
public class BRockExtensometer extends BXyzPoint {
    ...
    public ArrayList<BRockExtensometerPoint> getPoints() {
        return mPoints;
    }
    ...
    public void setPoints(ArrayList<BRockExtensometerPoint> points) {
        this.mPoints = points;
    }
    ...
    public class Ext extends BXyzPoint.Ext<BRockExtensometerPointObservation> {
