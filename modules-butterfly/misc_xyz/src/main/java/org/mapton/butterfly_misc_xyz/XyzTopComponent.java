...
@ActionID(category = "Butterfly", id = "org.mapton.butterfly-misc-xyz.XyzTopComponent")
@ActionReferences({
    @ActionReference(path = "Menu/MapTools/Butterfly/Misc", position = 1)
})
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_XyzAction",
        preferredID = "XyzTopComponent"
)
@Messages({
...
public final class XyzTopComponent extends MTopComponent {
    ...
    public XyzTopComponent() {
        setName(Bundle.CTL_XyzAction());
    }
    ...
    private Scene createScene() {
        var xyzView = new XyzContentView(XyzContentOptions.getInstance());
