 ...
 */
public class XyzFilterPopOver extends BaseTabbedFilterPopOver {

    private final XyzFilter mFilter;
    ...
    public XyzFilterPopOver(ButterflyFormFilter filter) {
