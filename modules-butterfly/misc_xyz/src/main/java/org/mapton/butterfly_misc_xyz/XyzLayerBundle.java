...
public class XyzLayerBundle extends BfLayerBundle {

    private final XyzAttributeManager mAttributeManager = XyzAttributeManager.getInstance();
    private final GraphicRenderer mGraphicRenderer;
    private final XyzLayerOptions mLayerOptions = XyzLayerOptions.getInstance();
    private final XyzLayerOptionsView mLayerOptionsView;
    private final XyzManager mManager = XyzManager.getInstance();

    public XyzLayerBundle() {
        init();
        initRepaint();
        mLayerOptionsView = new XyzLayerOptionsView(this);
    ...
    private void init() {
        initCommons(Bundle.CTL_XyzAction(), Dict.MISCELLANEOUS.toString(), "XyzTopComponent");
    ...
    private PointPlacemark plotLabel(BXyzPoint p, XyzLabelBy labelBy, Position position) {
        if (labelBy == XyzLabelBy.NONE) {
            return null;
        } else {
