...
import org.mapton.butterfly_misc_xyz.XyzAttributeManager;

/**
 *
 * @author Patrik Karlström
 */
public abstract class GraphicRendererBase extends BaseGraphicRenderer<GraphicItem, BXyzPoint> {
    ...
    protected final XyzAttributeManager mAttributeManager = XyzAttributeManager.getInstance();
...
//    protected boolean isPlotLimitReached(BXyzPoint p, Object key, Position position) {
