...
import org.mapton.butterfly_misc_xyz.graphics.GraphicItem;
 ...
 */
public class XyzLayerOptionsView extends BLayerOptionsView {

    private final SessionComboBox<XyzColorBy> mColorScb = new SessionComboBox<>();
    ...
    private final SessionComboBox<XyzPointBy> mPointScb = new SessionComboBox<>();

    public XyzLayerOptionsView(XyzLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_XyzAction(), XyzLayerOptions.getInstance(), "xyz");
        createUI();
    ...
    private void createUI() {
        mPointScb.getItems().setAll(XyzPointBy.values());
        mColorScb.getItems().setAll(XyzColorBy.values());
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), XyzLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(XyzLabelBy.class, mLayerOptions.labelByProperty().get().name(), XyzLayerOptions.DEFAULT_LABEL_BY));
    ...
    private void initListerners() {
        mLayerOptions.labelByOperationProperty().addListener((p, o, n) -> {
            ...
            for (var labelBy : XyzLabelBy.values()) {
