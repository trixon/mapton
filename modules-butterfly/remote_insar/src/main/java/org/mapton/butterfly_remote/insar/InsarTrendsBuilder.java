 ...
 */
public class InsarTrendsBuilder extends BTrendsBuilder<BRemoteInsarPoint> {
    ...
    private void populate(BRemoteInsarPoint p, BComponent component, String cat1, LinkedHashMap<String, Object> propertyMap) {
