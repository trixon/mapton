 ...
 */
public class InsarLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static InsarLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private InsarLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final InsarLayerOptions INSTANCE = new InsarLayerOptions();
    }
}
