 ...
 */
public class RoiFilterPopOver extends BaseTabbedFilterPopOver {

    private final RoiFilter mFilter;
    ...
    public RoiFilterPopOver(ButterflyFormFilter filter) {
    ...
    public void load(Butterfly butterfly) {
        var rois = butterfly.getRois();

        mFilterSectionPoint.load(rois);
