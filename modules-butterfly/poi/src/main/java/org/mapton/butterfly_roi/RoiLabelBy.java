 ...
 */
public enum RoiLabelBy implements LabelBy.Operations {
    ...
    private RoiLabelBy(String category, String name, Function<BRoi, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
