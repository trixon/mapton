 ...
 */
public class RoiOptionsView extends BOptionsView {
    ...
    public RoiOptionsView(RoiLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_RoiAction(), RoiOptions.getInstance(), "roi");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mOptions.labelByOperationProperty(), RoiLabelBy.values());
        mLabelMenuButton.setText(mOptions.getLabelFromId(RoiLabelBy.class, mOptions.labelByProperty().get().name(), RoiOptions.DEFAULT_LABEL_BY));
