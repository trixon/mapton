 ...
 */
public class RoiLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static RoiLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private RoiLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final RoiLayerOptions INSTANCE = new RoiLayerOptions();
    }
}
