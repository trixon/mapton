 ...
 */
@ConvertAsProperties(
        dtd = "-//org.mapton.butterfly-roi//Roi//EN",
        autostore = false
)
...
@ActionID(category = "Butterfly", id = "org.mapton.butterfly-roi.RoiTopComponent")
@ActionReferences({
    @ActionReference(path = "Menu/MapTools/Butterfly/Misc", position = 1)
})
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_RoiAction",
        preferredID = "RoiTopComponent"
)
@Messages({
...
public final class RoiTopComponent extends MTopComponent {
    ...
    public RoiTopComponent() {
        setName(Bundle.CTL_RoiAction());
    }
