...
import org.mapton.butterfly_roi.graphics.GraphicItem;
 ...
 */
public class RoiLayerOptionsView extends BLayerOptionsView {

    private final SessionComboBox<RoiColorBy> mColorScb = new SessionComboBox<>();
    ...
    private final SessionComboBox<RoiPointBy> mPointScb = new SessionComboBox<>();

    public RoiLayerOptionsView(RoiLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_RoiAction(), RoiLayerOptions.getInstance(), "roi");
        createUI();
    ...
    private void createUI() {
        mPointScb.getItems().setAll(RoiPointBy.values());
        mColorScb.getItems().setAll(RoiColorBy.values());
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), RoiLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(RoiLabelBy.class, mLayerOptions.labelByProperty().get().name(), RoiLayerOptions.DEFAULT_LABEL_BY));
    ...
    private void initListerners() {
        mLayerOptions.labelByOperationProperty().addListener((p, o, n) -> {
            ...
            for (var labelBy : RoiLabelBy.values()) {
