 ...
 */
public class ConvergenceLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static ConvergenceLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private ConvergenceLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final ConvergenceLayerOptions INSTANCE = new ConvergenceLayerOptions();
    }
}
