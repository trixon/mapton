...
public class ConvergenceMultiChartPart extends BMultiChartPart {

    public ConvergenceMultiChartPart() {
    }
    ...
    public ArrayList<BRockConvergence> getPoints(MLatLon latLon, LocalDate firstDate, LocalDate date, LocalDate lastDate) {
        ...
        }).sorted(new Comparator<BRockConvergence>() {
            @Override
            public int compare(BRockConvergence o1, BRockConvergence o2) {
