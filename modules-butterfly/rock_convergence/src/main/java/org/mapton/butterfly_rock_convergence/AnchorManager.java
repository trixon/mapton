...
public class AnchorManager extends BaseManager<BTopoConvergencePair> {
    ...
    public Object getMapIndicator(BTopoConvergencePair pair) {
        ...
        var offset = ConvergenceManager.getInstance().getOffset();
        ...
        List.of(e1, e2).forEach(e -> {
            var leftClickRunnable = (Runnable) () -> {
                Mapton.getGlobalState().put(AnchorChartBuilder.class.getName() + "node", e.getValue(nameKey));
            };
...
//            pair.setObservations(observations);
    ...
    private static class Holder {
        ...
        private static final AnchorManager INSTANCE = new AnchorManager();
    }
}
