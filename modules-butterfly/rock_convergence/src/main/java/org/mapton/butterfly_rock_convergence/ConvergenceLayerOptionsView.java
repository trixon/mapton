 ...
 */
public class ConvergenceLayerOptionsView extends BLayerOptionsView {
    ...
    public ConvergenceLayerOptionsView(ConvergenceLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_ConvergenceAction(), ConvergenceLayerOptions.getInstance(), "convergence");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), ConvergenceLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(ConvergenceLabelBy.class, mLayerOptions.labelByProperty().get().name(), ConvergenceLayerOptions.DEFAULT_LABEL_BY));
