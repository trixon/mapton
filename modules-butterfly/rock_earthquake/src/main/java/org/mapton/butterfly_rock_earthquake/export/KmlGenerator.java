 ...
 */
package org.mapton.butterfly_rock_earthquake.export;
...
//                        .addToPair(KmlFactory.createPair().withKey(StyleState.HIGHLIGHT).withStyleUrl("#" + styleHighlightId));
    ...
    private void plot(InfluenceCircle influenceCircle, Folder folder, BRockEarthquake p, TimeStamp timeStamp) {
