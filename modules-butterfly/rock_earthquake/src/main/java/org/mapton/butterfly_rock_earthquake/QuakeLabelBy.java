 ...
 */
public enum QuakeLabelBy implements LabelBy.Operations {
    ...
    private final Function<BRockEarthquake, String> mFunction;
    private final String mName;

    private QuakeLabelBy(String category, String name, Function<BRockEarthquake, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BRockEarthquake o) {
        try {
