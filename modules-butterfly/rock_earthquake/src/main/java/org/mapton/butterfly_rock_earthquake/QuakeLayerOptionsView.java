...
import org.mapton.butterfly_rock_earthquake.graphics.GraphicItem;
 ...
 */
public class QuakeLayerOptionsView extends BLayerOptionsView {

    private final SessionComboBox<QuakeColorBy> mColorScb = new SessionComboBox<>();
    ...
    private final SessionComboBox<QuakePointBy> mPointScb = new SessionComboBox<>();

    public QuakeLayerOptionsView(QuakeLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_EarthquakeAction(), QuakeLayerOptions.getInstance(), "quake");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), QuakeLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(QuakeLabelBy.class, mLayerOptions.labelByProperty().get().name(), QuakeLayerOptions.DEFAULT_LABEL_BY));
...
//        activateAnnotation();
    ...
    private void initListerners() {
        mLayerOptions.labelByOperationProperty().addListener((p, o, n) -> {
            ...
            for (var labelBy : QuakeLabelBy.values()) {
