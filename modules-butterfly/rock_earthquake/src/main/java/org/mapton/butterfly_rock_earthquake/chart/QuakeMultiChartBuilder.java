 ...
 */
public class QuakeMultiChartBuilder extends XyzChartBuilder<BRockEarthquake> {
    ...
    public QuakeMultiChartBuilder(String titlePrefix, String axisLabel, String decimalPattern) {
        mTitlePrefix = titlePrefix;
        initChart(axisLabel, decimalPattern);
    }

    public synchronized Callable<ChartPanel> build(BRockEarthquake p, BMultiChartPart multiChartComponent) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public Object build(BRockEarthquake selectedObject) {
    ...
    @Override
    public void setTitle(BRockEarthquake b) {
