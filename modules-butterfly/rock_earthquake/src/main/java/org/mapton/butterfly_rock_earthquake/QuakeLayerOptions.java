 ...
 */
public class QuakeLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static QuakeLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private QuakeLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final QuakeLayerOptions INSTANCE = new QuakeLayerOptions();
    }
}
