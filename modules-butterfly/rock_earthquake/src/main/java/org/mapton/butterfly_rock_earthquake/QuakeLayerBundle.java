...
public class QuakeLayerBundle extends BfLayerBundle {
    ...
    private PointPlacemark plotLabel(BRockEarthquake p, QuakeLabelBy labelBy, Position position) {
        if (labelBy == QuakeLabelBy.NONE) {
            return null;
        } else {
