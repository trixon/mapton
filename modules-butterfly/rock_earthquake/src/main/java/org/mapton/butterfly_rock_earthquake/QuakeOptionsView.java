...
import org.mapton.butterfly_rock_earthquake.graphic.GraphicItem;
...
public class QuakeOptionsView extends BOptionsView {
    ...
    private static final QuakeLabelBy DEFAULT_LABEL_BY = QuakeLabelBy.NONE;
    ...
    public QuakeOptionsView(QuakeLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_EarthquakeAction());
    ...
    private void initSession() {
        ...
        restoreLabelFromId(QuakeLabelBy.class, DEFAULT_LABEL_BY);
    }
}
