 ...
 */
public class InclinoFilterPopOver extends BaseTabbedFilterPopOver {

    private final ResourceBundle mBundle = NbBundle.getBundle(InclinoFilterPopOver.class);
    private final InclinoFilter mFilter;
