 ...
 */
public class InclinoLayerOptionsView extends BLayerOptionsView {
    ...
    public InclinoLayerOptionsView(InclinoLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_InclinometerAction(), InclinoLayerOptions.getInstance(), "inclino");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), InclinoLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(InclinoLabelBy.class, mLayerOptions.labelByProperty().get().name(), InclinoLayerOptions.DEFAULT_LABEL_BY));
...
//        activateAnnotation();
    ...
    private void initSession() {
        ...
        mScaleScb.selectedProperty().bindBidirectional(mLayerOptions.scaleByAlarmProperty());
