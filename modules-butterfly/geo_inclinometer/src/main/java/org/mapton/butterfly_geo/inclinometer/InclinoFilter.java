 ...
 */
public class InclinoFilter extends ButterflyFormFilter<InclinoManager> implements
        FilterSectionMiscProvider,
        BFilterSectionPointProvider,
        BFilterSectionDateProvider,
        BFilterSectionDisruptorProvider {

    private final ResourceBundle mBundle = NbBundle.getBundle(InclinoFilter.class);
