 ...
 */
public class InclinoLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static InclinoLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private InclinoLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final InclinoLayerOptions INSTANCE = new InclinoLayerOptions();
    }
}
