 ...
 */
public class InclinoPropertiesBuilder extends PropertiesBuilder<BGeoInclinometerPoint> {

    private final ResourceBundle mBundle = NbBundle.getBundle(InclinoPropertiesBuilder.class);
