 ...
 */
public class VibrationLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static VibrationLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private VibrationLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final VibrationLayerOptions INSTANCE = new VibrationLayerOptions();
    }
}
