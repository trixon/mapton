 ...
 */
public class ExtensoLayerOptionsView extends BLayerOptionsView {
    ...
    public ExtensoLayerOptionsView(ExtensoLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_ExtensometerAction(), ExtensoLayerOptions.getInstance(), "extenso");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), ExtensoLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(ExtensoLabelBy.class, mLayerOptions.labelByProperty().get().name(), ExtensoLayerOptions.DEFAULT_LABEL_BY));
