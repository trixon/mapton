...
public class ExtensoOptionsView extends BOptionsView {
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mOptions.labelByOperationProperty(), ExtensoLabelBy.values());
        mLabelMenuButton.setText(mOptions.getLabelFromId(ExtensoLabelBy.class, mOptions.labelByProperty().get().name(), ExtensoOptions.DEFAULT_LABEL_BY));
