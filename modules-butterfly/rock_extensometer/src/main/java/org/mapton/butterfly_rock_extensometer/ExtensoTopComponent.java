 ...
 */
@ConvertAsProperties(
        dtd = "-//org.mapton.butterfly-rock-extensometer//Act//EN",
        autostore = false
)
...
@ActionID(category = "Butterfly", id = "org.mapton.butterfly-rock-extensometer.ExtensoTopComponent")
@ActionReferences({
    @ActionReference(path = "Menu/MapTools/Butterfly/Rock", position = 100)
})
...
public final class ExtensoTopComponent extends MTopComponent {
    ...
    private Scene createScene() {
        var hydroView = new ExtensoContentView(ExtensoContentOptions.getInstance());
