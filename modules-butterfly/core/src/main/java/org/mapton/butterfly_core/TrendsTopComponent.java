...
@TopComponent.Description(
        preferredID = "TrendsTopComponent",
...
public final class TrendsTopComponent extends MTopComponent {
    ...
    protected void initFX() {
        setScene(new Scene(new TrendsView()));
        Mapton.getGlobalState().put(MKey.OBJECT_TRENDS, Mapton.getGlobalState().get(MKey.OBJECT_TRENDS));
    }
    ...
    class TrendsView extends BorderPane {
        ...
        private void createUI() {
            ...
            mPlaceholderLabel = new Label(NbBundle.getMessage(getClass(), "object_trends_placeholder"), MaterialIcon._Action.ASSIGNMENT.getImageView(getIconSizeToolBar()));
