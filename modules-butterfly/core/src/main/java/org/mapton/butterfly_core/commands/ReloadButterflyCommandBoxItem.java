...
public class ReloadButterflyCommandBoxItem extends BBaseCommandBoxItem {

    public ReloadButterflyCommandBoxItem() {
    }

    @Override
    public String getParent() {
        return "%s/Utveckling/Skyll dig själv".formatted(super.getParent());
    }

    @Override
    public Action getAction() {
        return new Action("Läs in data på nytt", actionEvent -> {
