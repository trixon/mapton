 ...
 */
public abstract class BTrendsBuilder<T extends BXyzPoint> extends PropertiesBuilder<T> {
    ...
    private void populate(T p, BComponent component, String cat1, LinkedHashMap<String, Object> propertyMap) {
