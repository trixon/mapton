...
import org.mapton.butterfly_composite.graphics.GraphicRenderer;
...
public class CompositeLayerBundle extends BfLayerBundle {

    private final double SYMBOL_HEIGHT = 8.0;
    private final double SYMBOL_RADIUS = 0.5;

    private final CompositeAttributeManager mAttributeManager = CompositeAttributeManager.getInstance();
    private final GraphicRenderer mGraphicRenderer;
    private final CompositeLayerOptions mLayerOptions = CompositeLayerOptions.getInstance();
    private final CompositeLayerOptionsView mLayerOptionsView;
    private final CompositeManager mManager = CompositeManager.getInstance();

    public CompositeLayerBundle() {
        init();
        initRepaint();
        mLayerOptionsView = new CompositeLayerOptionsView(this);
    ...
    private void init() {
        initCommons(Bundle.CTL_CompositeAction(), Dict.MISCELLANEOUS.toString(), "CompositeTopComponent");
