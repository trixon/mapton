 ...
 */
public class CompositeFilter extends ButterflyFormFilter<CompositeManager> implements
    ...
    private final ResourceBundle mBundle = NbBundle.getBundle(CompositeFilter.class);
    private final CompositeManager mManager = CompositeManager.getInstance();

    public CompositeFilter() {
        super(CompositeManager.getInstance());
        mContentOptions = CompositeContentOptions.getInstance();
