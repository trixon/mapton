 ...
 */
public class TiltLayerOptionsView extends BLayerOptionsView {
    ...
    private final TiltLayerOptions mLayerOptions = TiltLayerOptions.getInstance();
    private final SessionComboBox<TiltPointBy> mPointScb = new SessionComboBox<>();

    public TiltLayerOptionsView(TiltLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_TiltAction(), TiltLayerOptions.getInstance(), "tilt");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), TiltLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(TiltLabelBy.class, mLayerOptions.labelByProperty().get().name(), TiltLayerOptions.DEFAULT_LABEL_BY));
