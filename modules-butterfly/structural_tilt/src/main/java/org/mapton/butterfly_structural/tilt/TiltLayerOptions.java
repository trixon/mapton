 ...
 */
public class TiltLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static TiltLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private TiltLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final TiltLayerOptions INSTANCE = new TiltLayerOptions();
    }
}
