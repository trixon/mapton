 ...
 */
public class MultiChartBuilder extends XyzChartBuilder<BStructuralTiltPoint> {
    ...
    public synchronized Callable<ChartPanel> build(BStructuralTiltPoint p, BMultiChartPart multiChartComponent) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public Object build(BStructuralTiltPoint selectedObject) {
    ...
    @Override
    public void setTitle(BStructuralTiltPoint b) {
