...
public abstract class BlastMultiChartPart extends BMultiChartPart {
    ...
    private final Predicate<BStructuralTiltPoint> mPredicate;

    public BlastMultiChartPart(Predicate<BStructuralTiltPoint> predicate) {
    ...
    public ArrayList<BStructuralTiltPoint> getPoints(MLatLon latLon, LocalDate firstDate, LocalDate date, LocalDate lastDate) {
        ...
        var pointsToExclude = new ArrayList<BStructuralTiltPoint>();
        for (var p : pointList) {
            var observations = p.ext().getObservationsTimeFiltered().stream()
                    ...
                    .map(o -> {
                        var oo = new BStructuralTiltPointObservation();
