 ...
 */
public enum PreDrillLabelBy implements LabelBy.Operations {
    ...
    private final Function<BGeoPreDrillPoint, String> mFunction;
    private final String mName;

    private PreDrillLabelBy(String category, String name, Function<BGeoPreDrillPoint, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BGeoPreDrillPoint o) {
        try {
