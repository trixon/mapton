 ...
 */
public class PreDrillAttributeManager extends BaseAttributeManager {
    ...
    public static PreDrillAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private PreDrillAttributeManager() {
    }
    ...
    private static class Holder {
        ...
        private static final PreDrillAttributeManager INSTANCE = new PreDrillAttributeManager();
    }
}
