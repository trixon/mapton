 ...
 */
public class PreDrillFilterPopOver extends BaseTabbedFilterPopOver {

    private final PreDrillFilter mFilter;
    ...
    public PreDrillFilterPopOver(PreDrillFilter filter) {
    ...
    public void load(Butterfly butterfly) {
        var drillings = butterfly.geotechnical().getGeoPreDrillPoints();
