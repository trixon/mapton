 ...
 */
package org.mapton.butterfly_geo_predrilling.chart;
 ...
 */
public class PreDrillMultiChartBuilder extends XyzChartBuilder<BGeoPreDrillPoint> {
    ...
    public PreDrillMultiChartBuilder(String titlePrefix, String axisLabel, String decimalPattern) {
        mTitlePrefix = titlePrefix;
        initChart(axisLabel, decimalPattern);
    }

    public synchronized Callable<ChartPanel> build(BGeoPreDrillPoint p, BMultiChartPart multiChartComponent) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public Object build(BGeoPreDrillPoint selectedObject) {
    ...
    @Override
    public void setTitle(BGeoPreDrillPoint b) {
...
//        setTitle(p, Color.BLUE);
    ...
    @Override
    public void updateDataset(BGeoPreDrillPoint b) {
        var plot = (XYPlot) mChart.getPlot();
        resetPlot(plot);
