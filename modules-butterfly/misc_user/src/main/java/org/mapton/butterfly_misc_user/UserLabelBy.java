 ...
 */
public enum UserLabelBy implements LabelBy.Operations {
    ...
    private final Function<BXyzPoint, String> mFunction;
    private final String mName;

    private UserLabelBy(String category, String name, Function<BXyzPoint, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BXyzPoint o) {
        try {
