...
import org.mapton.butterfly_geo_reinforcement.graphics.GraphicRenderer;
...
public class ReinforcementLayerBundle extends BfLayerBundle {
    ...
    private final ReinforcementLayerOptionsView mLayerOptionsView;
    private final ReinforcementManager mManager = ReinforcementManager.getInstance();

    public ReinforcementLayerBundle() {
        init();
        initRepaint();
        mLayerOptionsView = new ReinforcementLayerOptionsView(this);
    ...
    private PointPlacemark plotLabel(BGeoReinforcementPoint p, ReinforcementLabelBy labelBy, Position position) {
        if (labelBy == ReinforcementLabelBy.NONE) {
            return null;
        } else {
    ...
    private PointPlacemark plotPin(BGeoReinforcementPoint p, Position position, PointPlacemark labelPlacemark) {
