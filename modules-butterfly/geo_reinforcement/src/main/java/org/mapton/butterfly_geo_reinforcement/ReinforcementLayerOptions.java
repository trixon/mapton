 ...
 */
public class ReinforcementLayerOptions extends BLayerOptions implements MPresetActions {
    ...
    public static ReinforcementLayerOptions getInstance() {
        return Holder.INSTANCE;
    }

    private ReinforcementLayerOptions() {
    ...
    private static class Holder {
        ...
        private static final ReinforcementLayerOptions INSTANCE = new ReinforcementLayerOptions();
    }
}
