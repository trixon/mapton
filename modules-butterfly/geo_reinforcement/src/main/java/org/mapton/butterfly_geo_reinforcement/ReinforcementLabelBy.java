 ...
 */
public enum ReinforcementLabelBy implements LabelBy.Operations {
    ...
    private final Function<BGeoReinforcementPoint, String> mFunction;
    private final String mName;

    private ReinforcementLabelBy(String category, String name, Function<BGeoReinforcementPoint, String> function) {
        mCategory = category;
        mName = name;
        mFunction = function;
    }
    ...
    public String getLabel(BGeoReinforcementPoint o) {
        try {
