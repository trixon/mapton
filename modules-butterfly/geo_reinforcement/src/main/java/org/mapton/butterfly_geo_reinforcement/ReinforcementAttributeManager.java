 ...
 */
public class ReinforcementAttributeManager extends BaseAttributeManager {
    ...
    public static ReinforcementAttributeManager getInstance() {
        return Holder.INSTANCE;
    }

    private ReinforcementAttributeManager() {
    }
    ...
    private static class Holder {
        ...
        private static final ReinforcementAttributeManager INSTANCE = new ReinforcementAttributeManager();
    }
}
