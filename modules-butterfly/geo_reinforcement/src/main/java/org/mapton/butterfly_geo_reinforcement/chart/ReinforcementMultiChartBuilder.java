 ...
 */
public class ReinforcementMultiChartBuilder extends XyzChartBuilder<BGeoReinforcementPoint> {
    ...
    public ReinforcementMultiChartBuilder(String titlePrefix, String axisLabel, String decimalPattern) {
        mTitlePrefix = titlePrefix;
        initChart(axisLabel, decimalPattern);
    }

    public synchronized Callable<ChartPanel> build(BGeoReinforcementPoint p, BMultiChartPart multiChartComponent) {
        if (p == null) {
            return null;
        }
    ...
    @Override
    public Object build(BGeoReinforcementPoint selectedObject) {
    ...
    @Override
    public void setTitle(BGeoReinforcementPoint b) {
...
//        setTitle(p, Color.BLUE);
    ...
    @Override
    public void updateDataset(BGeoReinforcementPoint b) {
        var plot = (XYPlot) mChart.getPlot();
        resetPlot(plot);
