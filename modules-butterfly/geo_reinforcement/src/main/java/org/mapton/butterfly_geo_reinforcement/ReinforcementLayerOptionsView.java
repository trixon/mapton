...
import org.mapton.butterfly_geo_reinforcement.graphics.GraphicItem;
 ...
 */
public class ReinforcementLayerOptionsView extends BLayerOptionsView {

    private final SessionComboBox<ReinforcementColorBy> mColorScb = new SessionComboBox<>();
    ...
    private final SessionComboBox<ReinforcementPointBy> mPointScb = new SessionComboBox<>();

    public ReinforcementLayerOptionsView(ReinforcementLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_ReinforcementAction(), ReinforcementLayerOptions.getInstance(), "reinforcement");
        createUI();
    ...
    private void createUI() {
        mPointScb.getItems().setAll(ReinforcementPointBy.values());
        mColorScb.getItems().setAll(ReinforcementColorBy.values());
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mLayerOptions.labelByOperationProperty(), ReinforcementLabelBy.values());
        mLabelMenuButton.setText(mLayerOptions.getLabelFromId(ReinforcementLabelBy.class, mLayerOptions.labelByProperty().get().name(), ReinforcementLayerOptions.DEFAULT_LABEL_BY));
    ...
    private void initListerners() {
        mLayerOptions.labelByOperationProperty().addListener((p, o, n) -> {
            ...
            for (var labelBy : ReinforcementLabelBy.values()) {
