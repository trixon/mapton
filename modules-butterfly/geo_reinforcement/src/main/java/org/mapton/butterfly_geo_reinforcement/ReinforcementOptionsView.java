 ...
 */
public class ReinforcementOptionsView extends BOptionsView {
    ...
    public ReinforcementOptionsView(ReinforcementLayerBundle layerBundle) {
        super(layerBundle, Bundle.CTL_ReinforcementAction(), ReinforcementOptions.getInstance(), "reinforcement");
        createUI();
    ...
    private void createUI() {
        ...
        LabelBy.populateMenuButton(mLabelMenuButton, mOptions.labelByOperationProperty(), ReinforcementLabelBy.values());
        mLabelMenuButton.setText(mOptions.getLabelFromId(ReinforcementLabelBy.class, mOptions.labelByProperty().get().name(), ReinforcementOptions.DEFAULT_LABEL_BY));
