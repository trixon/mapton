 ...
 */
package org.mapton.butterfly_geo_reinforcement.export;
...
//                        .addToPair(KmlFactory.createPair().withKey(StyleState.HIGHLIGHT).withStyleUrl("#" + styleHighlightId));
    ...
    private void plot(InfluenceCircle influenceCircle, Folder folder, BGeoReinforcementPoint p, TimeStamp timeStamp) {
