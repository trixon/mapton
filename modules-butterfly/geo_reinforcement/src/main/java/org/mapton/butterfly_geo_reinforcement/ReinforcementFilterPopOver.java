 ...
 */
public class ReinforcementFilterPopOver extends BaseTabbedFilterPopOver {

    private final ReinforcementFilter mFilter;
    ...
    public ReinforcementFilterPopOver(ButterflyFormFilter filter) {
        ...
        mFilter = (ReinforcementFilter) filter;
    ...
    public void load(Butterfly butterfly) {
        var drillings = butterfly.geotechnical().getReinforcementPoints();

        mFilterSectionPoint.load(drillings);
